...
namespace Program
{
    class Program
    {
        ...
        public static void Main()
        {
            ...
            if (GetBalanceStatus(sortedLines, balance) > 0) FindBalanceByDate(sortedLines, balance);
        ...
        {
            Console.Write("Введите дату и время формата ( YYYY-MM-DD HH:mm ) : ");
        ...
        public static int GetBalanceStatus(string[][] arrays, int balance, string date = "")
        {
            ...
            for (int i = 0; i < arrays.Length; i++)
            {
                ...
                if (line.Length > 2) balance = UpdateBalance(balance, int.Parse(line[1]), line[2]);
